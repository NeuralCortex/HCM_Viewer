...
public class Globals {
    ...
    public static final String BUNDLE_PATH = "com.fx.hcm.bundle.srtm";
    ...
    public static final String CSS_PATH = "/com/fx/hcm/style/hec.css";
    public static final String MOON_IMAGE_PATH = System.getProperty("user.dir") + "/images/mond_small.png";

    //FXML
    public static final String FXML_PATH = "/com/fx/hcm/fxml/";
    public static final String FXML_TABS_PATH = "/com/fx/hcm/fxml/tabs/";
    ...
    public static final String HCM_DIR = "HCM_DIR";
    public static final String HCM_TILE_DIR = "HCM_TILE_DIR";
    public static final String HCM_TILE_COLOR = "HCM_TILE_COLOR";
