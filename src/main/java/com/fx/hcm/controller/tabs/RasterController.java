...
import com.fx.hcm.cell.DirColorCell;
import com.fx.hcm.cell.SrtmFileColorCell;
import com.fx.hcm.controller.MainController;
import com.fx.hcm.controller.PopulateInterface;
import com.fx.hcm.dialog.ProgressDialog;
import com.fx.hcm.pojo.Dir;
import com.fx.hcm.pojo.Topo;
import com.fx.hcm.task.HcmRasterTask;
import com.fx.hcm.task.SrtmRasterTask;
...
public class RasterController implements Initializable, PopulateInterface {
    ...
    public void initialize(URL url, ResourceBundle bundle) {
        ...
        btnLoad.setOnAction(e -> {
            ...
            String saveDir = Globals.propman.getProperty(Globals.HCM_DIR, System.getProperty("user.dir"));
            ...
            if (dir != null && dir.isDirectory() && !allDirs) {

                Globals.propman.setProperty(Globals.HCM_DIR, dir.getAbsolutePath());
            ...
            if (dir != null && dir.isDirectory() && allDirs) {
                ...
                HcmRasterTask hcmRasterTask = new HcmRasterTask(progressDialog, dir.listFiles(), mapViewer, painters, tableView, color, tableViewDir, dirRow);
                new Thread(hcmRasterTask).start();
            }
        });
